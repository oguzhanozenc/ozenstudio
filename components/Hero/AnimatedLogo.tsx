...
/* StrictMode-safe phase scheduler */
function usePhases(enabled: boolean) {
  ...
  useEffect(() => {
    ...
    PHASE_TIMINGS.forEach(({ phase, at }) => {
      const id = window.setTimeout(() => setPhase(phase), at);
...
export default function AnimatedLogo() {
  ...
  /* GAP reads window only on client */
